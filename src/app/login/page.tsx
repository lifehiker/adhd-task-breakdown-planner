      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Sign in to FocusSteps</CardTitle>
            <CardDescription>Save your progress and access your sessions from anywhere.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-center text-xs text-gray-400">
              Your sessions will be saved locally without an account.
            </p>
          </CardContent>
        </Card>
