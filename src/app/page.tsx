    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 py-24 text-center">
        <div className="max-w-4xl mx-auto">
          <Badge className="mb-6 bg-purple-100 text-purple-700 border-0">Built for ADHD brains</Badge>
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
            Break Any Task Into <span className="text-[#7c3aed]">Tiny Steps</span> And Actually Start
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Task paralysis stops here. Get 5-8 tiny actionable steps in seconds. No setup. Just start.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/app/new">
              <Button size="lg" className="bg-[#7c3aed] hover:bg-[#6d28d9] text-lg px-8 py-6">
          ...
          <p className="mt-4 text-sm text-gray-400">No account required. 5 AI breakdowns free per month.</p>
        </div>
      </section>
      <section className="bg-gray-50 px-6 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "1", title: "Type Your Task", desc: "Paste anything. The AI figures it out." },
              { step: "2", title: "AI Breaks It Down", desc: "Claude AI creates 5-8 tiny, concrete, timed steps." },
              { step: "3", title: "Work One Step at a Time", desc: "See one step at a time. Hit Done. Move on." },
            ].map((item) => (
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <Card className="border-2 border-[#7c3aed] relative">
      ...
      <section className="bg-[#7c3aed] px-6 py-20 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">Your brain works differently. That is okay.</h2>
          <p className="text-purple-200 text-lg mb-8">Built for the moments when your to-do list feels impossible.</p>
          <Link href="/app/new">
            <Button size="lg" className="bg-white text-[#7c3aed] hover:bg-gray-50 text-lg px-8 py-6">
      ...
      <footer className="border-t border-gray-100 px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="font-semibold text-gray-900">FocusSteps</span>
